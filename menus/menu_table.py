...
class MenuTable:
    ...
    def get_current_data(self):
        return self._data[self._curr_entry][0]
    ...
    def on_render(self, screen):
        screen.put_string(self._pos[0] + 0, self._pos[1] + 0, self._str_head)
        screen.put_string(self._pos[0] + 1, self._pos[1] + 0, self._str_head_sep)
    ...
    def __spawn_layout(self):
        ...
        for i, d in enumerate(self._data):
            ...
            for j, col in enumerate(self._columns):
                label += str(field_list[j]).rjust(col[1]) + '│'
